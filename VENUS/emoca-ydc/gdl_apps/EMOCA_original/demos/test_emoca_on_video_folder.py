...
from gdl_apps.EMOCA_original.utils.load import load_model
from gdl.datasets.FaceVideoDataModule import TestFaceVideoDM
import gdl
from pathlib import Path
from tqdm import auto
import argparse
from gdl_apps.EMOCA_original.utils.io import save_obj, save_images, save_codes, test
...
def reconstruct_video(args):
    ...
    if args.logger == "wandb":
        from gdl_apps.EMOCA_original.training.test_and_finetune_deca import  create_logger, project_name
        import wandb
...
def parse_args():
    ...
    parser.add_argument('--input_video', type=str, default="" , help="if not specified, the input folder will be used")
...
def main():
    ...
    for video_path in videos:
        ...
        args.output_folder = os.path.join(output_folder, video_name)
