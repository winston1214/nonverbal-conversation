...
class SMPLX(object):
    def __init__(self):
        ...
        self.layer = {'neutral': smplx.create(cfg.human_model_path, 'smplx', gender='NEUTRAL', use_pca=False, use_face_contour=True, **self.layer_arg),
                        ...
                        } ## will be using the base face mesh setup for the <NEUTRAL> case ##
        self.vertex_num = 10475
        self.face = self.layer['neutral'].faces ## fixed template mesh for face ##
        ...
        ## face vertex will also be fixed, and the expr_param, 
        ...
        ('Pelvis', 'L_Hip', 'R_Hip', 'Spine_1', 'L_Knee', 'R_Knee', 'Spine_2', 'L_Ankle', 'R_Ankle', 'Spine_3', 'L_Foot', 'R_Foot', 'Neck', 'L_Collar', 'R_Collar', 'Head', \
            'L_Shoulder', 'R_Shoulder', 'L_Elbow', 'R_Elbow', 'L_Wrist', 'R_Wrist', # body joints (22) -> 뒤에 6개만 사용하는 과정에서 
